...
- (void)longPressGestureRecognizerTriggerd:(UILongPressGestureRecognizer *)longPress
{
    switch (longPress.state) {
        ...
        case UIGestureRecognizerStateBegan:
        {
            ...
            KXPublicStatusCell *sourceCell = (KXPublicStatusCell *)sourceCollectionViewCell;
            ...
            //3.删除 按钮，防止 截图上已有 删除按钮 的叠影
            if (sourceCell.deleteBtn.isHidden) {
                [_beingMovedPromptView addSubview:self.deleteBtn];
            }
            //4.内部刷新
...
{
    if (!_deleteBtn) {
        _deleteBtn = [[UIButton alloc] initWithFrame:CGRectMake(_beingMovedPromptView.tz_width - 46, 0, 26, 26)];
